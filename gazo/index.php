...
print_r($data);
echo '</pre>';
echo $data['responses'][0]['textAnnotations'][0]['description'];
echo '<br />';
echo str_replace("\n","<br />",$data['responses'][0]['textAnnotations'][0]['description']);
echo '<br />';
echo  nl2br($data['responses'][0]['textAnnotations'][0]['description']);
	//echo "<h2>ヘッダー</h2>" ;
	//echo $header ;
?>
